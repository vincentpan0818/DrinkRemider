...
private struct OnboardingFlow: View {
  ...
  var body: some View {
    ZStack {
      LinearGradient(
        colors: [Color.sipBackground, Color.sipCloud], startPoint: .topLeading,
    ...
    Button {
      ...
      .overlay {
        RoundedRectangle(cornerRadius: 24)
          .stroke(
            selectedUnit == unit ? Color.sipTeal : Color.sipStroke,
...
extension View {
  fileprivate func adBannerInset() -> some View {
...
extension Color {
  fileprivate static let sipTeal = adaptive(
    light: Color(red: 0.05, green: 0.72, blue: 0.65),
    dark: Color(red: 0.07, green: 0.85, blue: 0.93))
  fileprivate static let sipMint = adaptive(
    light: Color(red: 0.18, green: 0.84, blue: 0.75),
    dark: Color(red: 0.11, green: 0.70, blue: 0.82))
  fileprivate static let sipCloud = adaptive(
    light: Color(red: 0.93, green: 0.98, blue: 0.97),
    dark: Color(red: 0.10, green: 0.10, blue: 0.12))
  fileprivate static let sipBackground = adaptive(
    light: Color(red: 0.96, green: 0.97, blue: 0.98), dark: Color.black)
  fileprivate static let sipCardBackground = adaptive(
    light: Color.white, dark: Color(red: 0.11, green: 0.11, blue: 0.12))
  fileprivate static let sipStroke = adaptive(
    light: Color(red: 0.88, green: 0.91, blue: 0.93),
    dark: Color(red: 0.22, green: 0.22, blue: 0.23))
  fileprivate static let sipAdOrange = Color(red: 0.96, green: 0.52, blue: 0.16)
  fileprivate static let sipReminderBlue = adaptive(
    light: Color(red: 0.08, green: 0.50, blue: 0.93),
